...
for i, (name, line) in enumerate(corpus):
    for word in line:
...
def other_results(species):
    for i, (name, document) in enumerate(corpus):
        if name == species:
            print name, species
            print i, document
